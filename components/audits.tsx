        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-4xl sm:text-center">
                    <h2 className="text-base font-semibold leading-7 text-indigo-600">Audits</h2>
                        ...
                        {tiers.map((tier) => (
                            <div key={tier.id} className="pt-16 lg:px-8 lg:pt-0 xl:px-14">
                                <p className="mt-0 flex items-baseline gap-x-1">
                                    <span className="text-5xl font-bold tracking-tight text-gray-900">audit name</span>
                                </p>
                                
                                <p className="mt-3 text-sm font-semibold leading-6 text-gray-900">{tier.description}</p>
