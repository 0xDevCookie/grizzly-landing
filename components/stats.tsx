        ...
        <div className="py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl">Our mission</h2>
                            ...
                            <dl className="w-64 space-y-8 xl:w-80">
                                {siteConfig.stats.map((stat) => (
                                    <div key={stat.label} className="flex flex-col-reverse gap-y-4">
                                        ...
                                        <dd className="text-5xl font-semibold tracking-tight text-gray-900  dark:text-gray-100">{stat.value}</dd>
                                    </div>
                                ))}
                            </dl>
                        </div>
